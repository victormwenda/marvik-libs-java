...
/**
 * Created by VRWANDA on 5/30/2017.
 */
...
public class Patterns {
   ...
   public static final String IANA_TOP_LEVEL_DOMAINS =
     ...
     */
    public static final String LABEL_CHAR = "a-zA-Z0-9" + UCS_CHAR;
    /**
     * Valid characters for IRI TLD defined in RFC 3987.
     */
    public static final String TLD_CHAR = "a-zA-Z" + UCS_CHAR;
    /**
    ...
    public static final String TLD = "(" + PUNYCODE_TLD + "|" + "[" + TLD_CHAR + "]{2,63}" + ")";
    public static final String HOST_NAME = "(" + IRI_LABEL + "\\.)+" + TLD;
    public static final String DOMAIN_NAME_STR = "(" + HOST_NAME + "|" + IP_ADDRESS_STRING + ")";
    ...
    public static final String USER_INFO = "(?:[a-zA-Z0-9\\$\\-\\_\\.\\+\\!\\*\\'\\(\\)"
     ...
     * defined in RFC5321: #&~!^`{}/=$*?|
     */
    public static final String EMAIL_CHAR = LABEL_CHAR + "\\+\\-_%'";
    /**
     ...
     */
    public static final String EMAIL_ADDRESS_LOCAL_PART =
     ...
     */
    public static final String EMAIL_ADDRESS_DOMAIN =
            "(?=.{1,255}(?:\\s|$|^))" + HOST_NAME;
    /**
